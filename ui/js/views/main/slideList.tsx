...
interface ICompProps extends React.Props<any> {
    ...
    showDetails: boolean,
    category: string,
    list: string, // which list on the home page
    ipp: number // number of items per page
}

class SlideList extends React.Component<IReduxProps & ICompProps, any> {
...
export default connect<{}, {}, ICompProps>(mapStateToProps, mapDispatchToProps)(SlideList);
