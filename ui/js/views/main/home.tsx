        ...
        <div className="home-section">
          <div className="latest">
            ...
            <div className="latest-list">
              {Object.keys(dataState.latest).length ?
                <SlidesList dataRef={dataState.latest} open={true} vertical={false} del={false} info={false} dots={true} list="latest" ipp="6" />
          ...
          <div className="watch-later">
            ...
            {Object.keys(dataState.watchLater).length ?
              <SlidesList dataRef={dataState.watchLater} open={false} vertical={true} del={true} info={true} dots={true} list="main" ipp="4" />
              : <FormattedMessage id='home.empty' />}
          </div>
        </div>
          ...
          <div className="recomm">
            ...
            <div className="recomm-list">
              {Object.keys(dataState.recomm).length ?
                <SlidesList dataRef={dataState.recomm} open={true} vertical={false} del={true} info={false} dots={true} list="recomm" ipp="8" />
                : <FormattedMessage id='home.empty' />}
            </div>
          </div>
        </div>
